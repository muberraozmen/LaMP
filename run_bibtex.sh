...
#SBATCH --output=out.bibtex.lamp_mrmp.log       # output file
#SBATCH --error=err.bibtex.lamp_mrmp.log           # error file

results_dir='/home/muberra/scratch/results_May5_bibtex_lamp/'
