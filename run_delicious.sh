...
#SBATCH --output=out.delicious.lamp2.log       # output file
#SBATCH --error=err.delicious.lamp2.log           # error file

results_dir='/home/muberra/scratch/results_May1_delicious_lamp2/'
